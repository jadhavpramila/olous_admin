  ...
  <div>
    <div class="main-container">
      <div class="main-container-header">
        <label class="font-weight-700 fontSize18 mb-0">Product Details </label>
      </div>
            ...
            <div class="d-flex" v-cloak>
              ...
              >
                <img
                  ...
                  class=""
                />
                <span class="mt-2 px-2"> Click to Add Product Image</span>
              </button>
            </div>
            <div
              class="invalid-feedback d-block"
...
export default {
  ...
  computed: {
    ...mapGetters(['getCurrentCompanyId', 'getCurrentEditProductData']),
    getImageMedia() {
      let image_media = []
  ...
  mounted() {
    if (this.isAddNewProduct) {
      ...
      this.productDetails = JSON.parse(
        JSON.stringify(this.getCurrentEditProductData)
      )
      if (
