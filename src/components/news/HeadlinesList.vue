  ...
  <div class="news-list">
    <div class="form-conatiner">
      <div class="d-flex justify-content-end">
        <span class="btn w-25" @click="addClick">Add Headlines</span>
      </div>
      <div class="mt-4">
        ...
        >
          <div
            ...
            v-for="(news, counter) in getAllNewsList"
            :key="counter"
          >
                ...
                <div class="row mt-3 mb-3">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="col-sm-9 col-md-9 col-lg-9">
                        <label>{{ getLocalDateTime(news.created_at) }}</label>
...
export default {
  ...
  methods: {
    ...
    getAllNews() {
      if (
        ...
        if (this.searchBy.length == 0) {
          ...
          this.fetchAllHeadlines(data).then((result) => {
            this.currentPage = data.pageNumber
            this.busy = false
            this.hasMoreNews = result
          })
        } else {
          this.fetchHeadlinesByFilter(data).then((result) => {
            this.currentPage = data.pageNumber
            this.busy = false
            this.hasMoreNews = result
          })
    ...
    deleteNewsFormDB() {
      this.deleteHeadline(this.delete_news_id)
