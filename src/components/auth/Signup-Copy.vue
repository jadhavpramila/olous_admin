<template>
  <div class="cls-signup container-fluid bg-black mb-12">
    <div class="bg-black relative d-flex justify-content-center">
      <div class="flex flex-col col-md-6 items-center space-3">
        <!-- <Toast /> -->
        <div class="bg-[#121415] pt-5 rounded-[2rem] signin-forms">
          <div v-if="!verified" class="d-flex justify-content-end">
            <span class="m-4 cursor-pointer" @click="clickClose()">
              <img src="../../assets/img/Close.svg" alt="" />
            </span>
          </div>
          <div
            v-if="!verified"
            class="px-4 md:px-0 lg:px-0 pb-11 signin-forms-inner"
          >
            <!-- signUp form -->
            <div v-if="!verified" class="flex flex-col items-center">
              <div class="d-flex flex-column align-items-center">
                <h5 class="font-weight-600">Sign Up</h5>
                <!-- phone or email -->
                  ...
                  <div class="flex flex-col space-4">
                    <div class="flex-col">
                      ...
                      <div
                        ...
                        v-if="submitted && !$v.form_data.first_name.required"
                      >
                        ...
                        <div class="col-md-2 pr-0">
                          ...
                          >
                            <span
                              ...
                              >+91</span
                            >
                            <span v-else> {{ form_data.country_code }}</span>
                          </button>
                          <div
                            class="invalid-feedback"
                            v-if="
                              submitted && !$v.form_data.country_code.required
                            "
                          >
                    ...
                    <span class="d-flex justify-content-center">
                      <button
                        class="mb-3 mt-2 border btn text-white px-3 py-1"
                        type="submit"
                        v-if="usePhone"
                        @click="removePhone()"
                      >
                    ...
                    <div class="mb-2">
                      <v-select
                        multiple
                        chips
                        v-model="interest_array"
                        :options="getInterestOptions"
                        label="display_string"
                        placeholder="Interest*"
                        :max="3"
                        class="w-full form-control show-dropdown-icon"
                        :class="{
                          'is-invalid': submitted && $v.interest_array.$invalid
                        }"
                      ></v-select>
                      <div
                        class="invalid-feedback"
                    ...
                    <span class="lg:w-[29.25rem] text-xs">
                      <p class="font-weight-300 fontSize12">
                    ...
                    <div
                      class="d-flex align-items-center justify-content-center space-x-2 pt-6 text-sm"
                    >
                      <!--  <Checkbox
                        v-model="terms"
                        name="code"
                      ...
                      <label for="code">
                        <span
                          class="d-flex text-white fontSize12 align-items-center"
                    ...
                    <div class="d-flex justify-content-center">
                      <button
                        @click="createAccount()"
                        class="mt-8 btn btn-cursor border text-white"
                      >
                    ...
                    <p class="fontSize12 mt-4 text-center">
                ...
                <span class="text-red-400 w-[20rem] text-center" v-if="error">{{
                  error
                }}</span>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters('dropdownValues', ['filteredCountry', 'getInterestOptions']),
    //...mapGetters(['getter_isUserLoggedIn']),
    buttonLabel() {
  ...
  methods: {
    ...
    ...mapActions('dropdownValues', ['searchContry', 'fetchInterestsData']),
    signIn() {
